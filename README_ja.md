...
- v2.0.1をリリースしました。(2026/7/23) (CVE-2026-25680脆弱性対応のための依存関係アップデート、ビルド・リリースワークフローの改善、ドキュメントの更新)

## ダウンロード

### 実行バイナリ
各プラットフォーム向けにビルド済みの実行ファイルは、[GitHubのリリース](https://github.com/twsnmp/twpcap/releases)からダウンロードできます。
